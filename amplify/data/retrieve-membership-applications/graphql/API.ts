...
export type ListMembershipApplicationByOrganizationIDQueryVariables = {
...
export type ListMembershipApplicationByOrganizationIDQuery = {
...
export type RetrieveMembershipApplicationsQueryVariables = {
};

export type RetrieveMembershipApplicationsQuery = {
  retrieveMembershipApplications?:  Array< {
    __typename: "MembershipApplication",
    birthDate: string,
    createdAt: string,
    id: string,
...
export type RetrieveOrganizationNameQueryVariables = {
  id: string,
};

export type RetrieveOrganizationNameQuery = {
  retrieveOrganizationName?: string | null,
};
