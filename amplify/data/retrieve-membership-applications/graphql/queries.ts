...
>;
export const listMembershipApplicationByOrganizationID = /* GraphQL */ `query ListMembershipApplicationByOrganizationID(
  ...
  listMembershipApplicationByOrganizationID(
    filter: $filter
    limit: $limit
    nextToken: $nextToken
...
` as GeneratedQuery<
  APITypes.ListMembershipApplicationByOrganizationIDQueryVariables,
  APITypes.ListMembershipApplicationByOrganizationIDQuery
>;
...
>;
export const retrieveMembershipApplications = /* GraphQL */ `query RetrieveMembershipApplications {
  retrieveMembershipApplications {
    birthDate
    createdAt
    id
    notMemberOfOtherCultivationAssociation
...
` as GeneratedQuery<
  APITypes.RetrieveMembershipApplicationsQueryVariables,
  APITypes.RetrieveMembershipApplicationsQuery
>;
export const retrieveOrganizationName = /* GraphQL */ `query RetrieveOrganizationName($id: ID!) {
  retrieveOrganizationName(id: $id)
}
` as GeneratedQuery<
  APITypes.RetrieveOrganizationNameQueryVariables,
  APITypes.RetrieveOrganizationNameQuery
>;
